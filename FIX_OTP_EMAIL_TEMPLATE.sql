-- Manual fix: Insert OTP email template with correct column names

DELETE FROM email_templates WHERE template_key = 'OTP_RESET_PASSWORD';

INSERT INTO email_templates (template_key, subject, html_body, text_body, placeholders, is_active, created_at, updated_at, last_updated_by)
VALUES (
    'OTP_RESET_PASSWORD',
